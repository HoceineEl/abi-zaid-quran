    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="max-w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">الرقم التعريفي
                                        </p>
                                        <p class="text-base font-semibold text-gray-900 dark:text-white">
                                            {{ $memorizer->id }}
                                        </p>
                ...
                @else
                    <div
                        class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg text-center text-gray-600 dark:text-gray-300">
                        لم يتم مسح أي رمز QR بعد
                    </div>
                @endif

                <input type="hidden" wire:model.live="scannedMemorizerId" id="scannedMemorizerId">
